...
using UseCase = FIAP.TechChalenge.EpicCollections.Application.UseCases.User.GetUser;

namespace FIAP.TechChalenge.EpicCollections.IntegrationTests.Application.UseCases.User.GetUser;
