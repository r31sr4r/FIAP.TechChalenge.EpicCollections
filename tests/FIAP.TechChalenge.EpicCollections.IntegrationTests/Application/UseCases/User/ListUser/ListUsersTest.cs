...
using UseCase = FIAP.TechChalenge.EpicCollections.Application.UseCases.User.ListUsers;
...
namespace FIAP.TechChalenge.EpicCollections.IntegrationTests.Application.UseCases.User.ListUser;
