...
using UseCase = FIAP.TechChalenge.EpicCollections.Application.UseCases.User.Update;
...
namespace FIAP.TechChalenge.EpicCollections.IntegrationTests.Application.UseCases.User.UpdateUser;
