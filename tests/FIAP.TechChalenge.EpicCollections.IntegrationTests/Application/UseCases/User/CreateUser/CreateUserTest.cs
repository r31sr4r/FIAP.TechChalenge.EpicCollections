...
using UseCase = FIAP.TechChalenge.EpicCollections.Application.UseCases.User.CreateUser;
using FIAP.TechChalenge.EpicCollections.Infra.Data.EF;

namespace FIAP.TechChalenge.EpicCollections.IntegrationTests.Application.UseCases.User.CreateUser;
