...
using Xunit;
using UseCases = FIAP.TechChalenge.EpicCollections.Application.UseCases.User.CreateUser;
using DomainEntity = FIAP.TechChalenge.EpicCollections.Domain.Entity;

namespace FIAP.TechChalenge.EpicCollections.UnitTests.Application.User.CreateUser;
