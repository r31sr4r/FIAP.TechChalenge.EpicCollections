...
using UseCases = FIAP.TechChalenge.EpicCollections.Application.UseCases.User.Update;
using Xunit;

namespace FIAP.TechChalenge.EpicCollections.UnitTests.Application.User.UpdateUser;
